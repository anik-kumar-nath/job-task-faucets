...
const faq = [
    {
        id: 0,
        question: 'What is blockchain oracle?',
    ...
    {
        id: 3,
        question: 'Where can I explore the performance and reliability of Chainlnk Network?',
    ...
    {
        id: 8,
        question: 'How do I reach out to Chainlink for support?',
...
const FAQ = () => {
    return (
        <div>
            <h2 className='text-center fw-semibold' style={{ 'color': primaryColor }}>Frequently Asked Questions</h2>
            <div className='mx-auto my-3' style={{ 'maxWidth': '720px', 'textAlign': 'justify' }}>
                <Accordion>
                    {
                        faq.map(item =>
                            <Accordion.Item key={item.id} eventKey={item.id}>
                                <Accordion.Header> <strong>{item.question}</strong> </Accordion.Header>
                                <Accordion.Body>
